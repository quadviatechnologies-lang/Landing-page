...
const Services: React.FC = () => {
  ...
  useEffect(() => {
    if (location.hash) {
      // Get the element ID from the URL hash
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="py-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Telecom Services */}{" "}
          <div className="mb-20" id="telecom-services">
            {" "}
            <ScrollAnimation>
              {" "}
              <div className="text-center mb-12">
                ...
                <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
                  We deliver comprehensive telecom infrastructure services, from
                  initial site planning to final commissioning, ensuring a
                  robust and reliable communication backbone for your
                  enterprise.{" "}
                </p>{" "}
              </div>{" "}
            </ScrollAnimation>{" "}
              ...
              {[
                {
                  ...
                  description:
                    "Comprehensive radio frequency analysis and strategic site planning for optimal coverage and performance.",
                },

                {
                  ...
                  description:
                    "Professional installation and commissioning of radio frequency equipment and systems.",
                },

                {
                  ...
                  description:
                    "Microwave antenna installation and alignment for high-capacity point-to-point communications.",
                },

                {
                  ...
                  description:
                    "Complete telecom infrastructure setup including towers, cabinets, and power systems.",
                },

                {
                  ...
                  description:
                    "Safe and environmentally responsible decommissioning of legacy telecom equipment.",
                },

                {
                  ...
                  description:
                    "Ongoing optimization services to ensure peak performance and reliability.",
                },
              ].map((service, index) => (
          ...
          <div className="mb-20" id="networking-solutions">
            {" "}
            <ScrollAnimation>
              {" "}
              <div className="text-center mb-12">
                ...
                <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
                  From structured LAN cabling to advanced SD-WAN solutions, we
                  design and deploy secure, high-speed networks that power your
                  business's productivity and connectivity.{" "}
                </p>{" "}
              </div>{" "}
            </ScrollAnimation>{" "}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {[
                {
                  ...
                  description:
                    "Enterprise-grade router and switch deployment with advanced configuration and optimization.",
                },

                {
                  ...
                  description:
                    "Professional structured cabling solutions for reliable and scalable network infrastructure.",
                },

                {
                  ...
                  description:
                    "High-performance wireless network design and implementation for seamless connectivity.",
                },

                {
                  ...
                  description:
                    "Software-defined wide area network solutions for optimized and secure branch connectivity.",
                },

                {
                  ...
                  description:
                    "Strategic placement and configuration of wireless access points for maximum coverage.",
                },

                {
                  ...
                  description:
                    "24/7 network monitoring and management services to ensure optimal performance.",
                },
              ].map((service, index) => (
                <ScrollAnimation key={index} delay={(index % 3) + 1}>
                  {" "}
          ...
          <div id="security-surveillance">
            ...
            <ScrollAnimation>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
                  We provide end-to-end security solutions, from advanced CCTV
                  to access control, designed to protect your assets and ensure
              ...
              {[
                {
                  ...
                  description:
                    "Advanced video surveillance systems with high-definition cameras and intelligent analytics.",
                },

                {
                  ...
                  description:
                    "Sophisticated access control solutions with biometric and card-based authentication.",
                },

                {
                  ...
                  description:
                    "Comprehensive alarm systems for intrusion detection and emergency response.",
                },

                {
                  ...
                  description:
                    "Communication and visitor management systems for enhanced security and convenience.",
                },

                {
                  ...
                  description:
                    "Firewall configuration, network security assessment, and cybersecurity consulting.",
                },

                {
                  ...
                  description:
                    "Comprehensive maintenance and support services to ensure continuous system reliability.",
                },
              ].map((service, index) => (
                <ScrollAnimation key={index} delay={(index % 3) + 1}>
                  {" "}
